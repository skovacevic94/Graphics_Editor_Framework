	...
	public void actionPerformed(ActionEvent e) {
		...
		if(med != null) {
			if(med.getDiagram().getSelModel().getSelectionListSize() == 1 &&
				...
				med.getCommandManager().addCommand(new RotateCommand(med, RotateCommand.RIGHT));
		}
	}
